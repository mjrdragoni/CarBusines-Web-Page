<?php
  ...
  if (isset($_SESSION['usuario']) || isset($_COOKIE['usuarioLogado'])) {
      ...
      $loged ='<td><a href="../views/view_reserva.php"><center><button type="button" class="btn btn-warning">Efetuar Reserva</button></center></a></td>';            
  }   
  else{
...
$sql = "SELECT car_models.name, brands.name AS brand_name, cars.color, cars.rental_price
